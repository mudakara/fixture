              ...
              {sportGames.map((sportGame) => (
                ...
                >
                  ...
                  <div className="px-4 py-5 sm:p-6">
                    ...
                    {/* Points Display - Made more prominent */}
                    {(sportGame.points?.first || sportGame.points?.second || sportGame.points?.third) && (
                      <div className="mt-4 p-3 bg-gray-50 rounded-lg">
                        <p className="text-sm font-semibold text-gray-900 mb-2">Points System</p>
                        <div className="grid grid-cols-3 gap-2">
                          {sportGame.points.first > 0 && (
                            <div className="bg-yellow-50 rounded-md p-2 text-center">
                              <span className="text-2xl">🥇</span>
                              <p className="text-sm font-bold text-gray-900 mt-1">{sportGame.points.first} pts</p>
                              <p className="text-xs text-gray-600">1st Place</p>
                            </div>
                          )}
                          {sportGame.points.second > 0 && (
                            <div className="bg-gray-100 rounded-md p-2 text-center">
                              <span className="text-2xl">🥈</span>
                              <p className="text-sm font-bold text-gray-900 mt-1">{sportGame.points.second} pts</p>
                          ...
                          {sportGame.points.third > 0 && (
                            <div className="bg-orange-50 rounded-md p-2 text-center">
                              <span className="text-2xl">🥉</span>
                              <p className="text-sm font-bold text-gray-900 mt-1">{sportGame.points.third} pts</p>
                    ...
                    {isAdmin && (
                      <div className="mt-4 pt-4 border-t border-gray-200 flex items-center justify-between space-x-3">
                        <Link
